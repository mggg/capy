...
name_dict_small = {"half_edge_0" : r"$\lambda = 0$", 
        "half_edge_lim" : r"$\lambda = \inf$"
        }
#        "half_edge_0.5" : r"$\lambda = 0.5$", 
#        "half_edge_2" : r"$\lambda = 2$", 
#        "half_edge_10" : r"$\lambda = 10$", 

multi_rankr("half_edge_1", weights_he, color_dict, top_100, name_dict, jitter_amount=JITTER_AMOUNT)
plt.savefig(f"Reproduction/Reproduction_Figures/lambda_rankings/{GEOGRAPHY}_in_{AREA_TYPE}_lambda_rankings_whitev{COMPARISON}_in_{YEAR}_with_{JITTER_AMOUNT}_jitter.png", dpi = 300, bbox_inches = "tight")