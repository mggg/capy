"""Pairwise rank comparison scatterplots — 1×3 panel.
...
Saves one panel PNG to:
    figures/baseline/<node_areas>_in_<study_areas>/rank_comparisons/<stem>_rank_panel.png

Usage (run from the project root):
    python experiment_code/baseline/visualization/rank_comparisons/rank_comparisons_panel.py
"""
...
panel_path = out_dir / f"{stem}_rank_panel.png"
