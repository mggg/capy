...
if "white_poc" in path_to_file:
    ...
    OUT = Path("figures") / "baseline" / "tracts_in_cbsa" / "lineplots" / "rho_vs_metrics_linear_wpoc.png"
elif "white_black" in path_to_file:
    df["rho"] = df["total_black"] / (df["total_black"] + df["total_white"])
    OUT = Path("figures") / "baseline" / "tracts_in_cbsa" / "lineplots" / "rho_vs_metrics_linear_wb.png"
else:
