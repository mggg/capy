...
DIFFUSION_DATA_DIR = MAIN_DIR / "data" / "experiment_specific"
METRICS = [("moran", "Moran's I"), ("dissimilarity", "Dissimilarity"),
           ("local_moran", "Sum of Local Moran's I of All Nodes in Region")]

tracts = pd.read_csv(DIFFUSION_DATA_DIR / "observed_diffusion_data" / "auto_cluster_tracts.csv", dtype={'area_code': str, 'gisjoin': str})
metrics = pd.read_csv(DIFFUSION_DATA_DIR / "observed_diffusion_data" / "auto_cluster_metrics.csv", dtype={'area_code': str})
...
for cluster in clusters:
    ...
    for metric in METRICS:
        ...
        plt.tight_layout()
        output = MAIN_DIR / f"figures/observed_diffusion/buffer_lineplots/{cluster[0]}_{cluster[1]}_{metric[1]}_by_buffer.png"
