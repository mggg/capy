...
tracts = pd.read_csv(MAIN_DIR / "data" / "experiment_specific" / "observed_diffusion_data" / "auto_cluster_tracts.csv", dtype={'area_code': str, 'gisjoin': str})
metrics = pd.read_csv(MAIN_DIR / "data" / "experiment_specific" / "observed_diffusion_data" / "auto_cluster_metrics.csv", dtype={'area_code': str})
...
for cluster in clusters:
    ...
    plt.tight_layout()
    output = MAIN_DIR / f"figures/observed_diffusion/single_line_plots/{cluster[0]}_{cluster[1]}_metrics.png"
