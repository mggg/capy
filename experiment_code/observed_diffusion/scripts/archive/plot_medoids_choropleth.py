...
GEO_DIR = EXPERIMENT_DIR / "data" / "shared" / "processed" / "clipped_geographies"
DIFFUSION_DATA_DIR = EXPERIMENT_DIR / "data" / "experiment_specific"
...
all_selections = pd.read_csv(DIFFUSION_DATA_DIR / "observed_diffusion_data" / "auto_cluster_tracts.csv", dtype={'area_code': str, 'gisjoin': str})
...
all_metrics = pd.read_csv(DIFFUSION_DATA_DIR / "observed_diffusion_data" / "auto_cluster_metrics.csv", dtype={'area_code': str, 'center_gisjoin': str})
