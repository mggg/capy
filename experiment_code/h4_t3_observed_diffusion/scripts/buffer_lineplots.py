...
"""
Plots an arbitrary number of metrics, (currently Moran's I, Dissimilarity, and Sum of Local Moran's I)
...
for cluster in clusters:
    ...
    for metric in METRICS:
        ...
        plt.tight_layout()
        fig.savefig(f"figures/misc_observed_diffusion_figs/{cluster[0]}_{cluster[1]}_{metric[1]}_by_buffer.png", bbox_inches='tight')
