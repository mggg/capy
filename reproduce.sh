...
fd "shp" cbsas/defs/ -x python intersection.py processed/2000_tracts.shp {} cbsas/2000/{/.}_cbsa_tracts.shp
fd "shp" cbsas/defs/ -x python intersection.py processed/1990_tracts.shp {} cbsas/1990/{/.}_cbsa_tracts.shp
fd "shp" cbsas/defs/ -x python intersection.py processed/1980_tracts.shp {} cbsas/1980/{/.}_cbsa_tracts.shp
fd "shp" cbsas/defs/ -x python intersection.py processed/1970_tracts.shp {} cbsas/1970/{/.}_cbsa_tracts.shp
